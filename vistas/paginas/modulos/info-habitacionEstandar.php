	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-12 col-lg-8 colIzqHabitaciones p-0">
				...
				<div class="pt-4 cabeceraHabitacion">
					...
					<ul class="nav nav-justified mt-lg-4">
						...
						<li class="nav-item">
							<a class="nav-link text-white" href="<?php echo $ruta;  ?>habitacionEspecial" >ESPECIAL</a>
						</li>
				...
				<section class="jd-slider mb-3 my-lg-3 slideHabitaciones">
			        ...
			        <div class="slide-inner">
			            ...
			            <ul class="slide-area">
				            <li>
								<img src="img/habitacion03.png" class="img-fluid">
							</li>
							<li>
								<img src="img/habitacion03.png" class="img-fluid">
							</li>
			...
			<div class="col-12 col-lg-4 colDerHabitaciones">
				<h2 class="colorTitulos">ESTANDAR INCLUYE:</h2>
				...
				<div class="habitaciones">
					<div class="container">
						<div class="row">
							...
							<div class="col-12 pb-3 px-0 px-lg-3">
								<a href="<?php echo $ruta;  ?>habitacionEspecial">
									...
									<figure class="text-center">
										...
										<h1 class="text-white p-3 mx-auto w-50 lead" style="background:#2F7D84">ESPECIAL</h1>
									</figure>
								</a>
							</div>
						</div>
