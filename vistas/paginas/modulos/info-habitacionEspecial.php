		...
		<div class="row">
			...
			<div class="col-12 col-lg-8 colIzqHabitaciones p-0">
				...
				<div class="pt-4 cabeceraHabitacion">
					...
					<h2 class="float-right text-white px-3 categoria">ESPECIAL</h2>
					<div class="clearfix"></div>
					<ul class="nav nav-justified mt-lg-4">
						<li class="nav-item">
							<a class="nav-link text-white active" href="<?php echo $ruta;  ?>habitacionEspecial" >
								<i class="fas fa-chevron-right"></i> ESPECIAL
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link text-white" href="<?php echo $ruta;  ?>habitacionSuite" >SUITE</a>
						</li>
						<li class="nav-item">
							<a class="nav-link text-white" href="<?php echo $ruta;  ?>habitacionEstandar" >ESTANDAR</a>
						</li>
				...
				<section class="jd-slider mb-3 my-lg-3 slideHabitaciones">
			        ...
			        <div class="slide-inner">
			            ...
			            <ul class="slide-area">
				            <li>
								<img src="img/habitacion02.png" class="img-fluid">
							</li>
							<li>
								<img src="img/habitacion02.png" class="img-fluid">
							</li>
			...
			<div class="col-12 col-lg-4 colDerHabitaciones">
				<h2 class="colorTitulos">ESPECIAL INCLUYE:</h2>
					...
					<div class="container">
						<div class="row">
							<div class="col-12 pb-3 px-0 px-lg-3">
								<a href="<?php echo $ruta;  ?>habitacionSuite">
									...
									<figure class="text-center">
										...
										<h1 class="text-white p-3 mx-auto w-50 lead" style="background:#197DB1">SUITE</h1>
									</figure>
								</a>
							</div>
							<div class="col-12 pb-3 px-0 px-lg-3">
								<a href="<?php echo $ruta;  ?>habitacionEstandar">
									...
									<figure class="text-center">
										...
										<h1 class="text-white p-3 mx-auto w-50 lead" style="background:#2F7D84">ESTANDAR</h1>
									</figure>
								</a>
							</div>
						</div>
